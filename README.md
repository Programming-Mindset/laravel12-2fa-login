Laravel 2FA is commonly referred to as "Two-Factor Authentication (2FA) via OTP" or "OTP-Based Login Verification" in Laravel. Some other names you might see for this implementation include:
### Login
